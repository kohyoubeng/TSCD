###############################################################################
# REPLICATION INSTRUCTIONS — Bur.SCD Model Estimation
#
# This script estimates the Bur.SCD duration model using a particle filter
...
be.int = 0.9
sig.int = 0.1
a.int = 1.1      # q-(1/a) > 0 so q*a > 1
q.int = 2.1      # q = b+(1/a)
initialTheta = c(miu.int, be.int, sig.int, a.int, q.int)
